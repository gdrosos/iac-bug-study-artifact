...
def print_os_tree(dataframe):
    ...
    print(f"{'Category':<34}{'Version Agnostic':<20}{'Version Dependent':<20}{'Total':<20}")
    print("-" * 80)
    print(f"{'Debian Family':<34}{debian_cnt:<20}{debian_cnt_version:<20}{debian_cnt+debian_cnt_version:<20}")
    print(f"{'RedHat Family':<34}{redhat_cnt:<20}{redhat_cnt_version:<20}{redhat_cnt+redhat_cnt_version:<20}")
    print(f"{'Other Linux':<34}{others_linux_cnt:<20}{others_linux_cnt_version:<20}{others_linux_cnt+others_linux_cnt_version:<20}")
    print("-" * 80)
    print(f"{'Total Linux (Subtotal)':<34}{linux_cnt:<20}{linux_cnt_version:<20}{linux_cnt+linux_cnt_version:<20}")
    print(f"{'Windows':<34}{windows_cnt:<20}{windows_cnt_version:<20}{windows_cnt+windows_cnt_version:<20}")
    print(f"{'Other OS':<34}{others_cnt:<20}{others_cnt_version:<20}{others_cnt+others_cnt_version:<20}")
    print("-" * 80)
    print(f"{'Total OS Sensitive (Subtotal)':<34}{os_sensitive_cnt:<20}{os_sensitive_version_cnt:<20}{os_sensitive_cnt+os_sensitive_version_cnt:<20}")
    # print("-" * 100)
    print(f"{'Single OS Support':<34}{single_os_support_cnt:<20}{'0':<20}{single_os_support_cnt:<20}")
    print(f"{'Multiple OS Support':<34}{multiple_os_support_cnt:<20}{'0':<20}{multiple_os_support_cnt:<20}")
    print("-" * 80)
    # print(f"{'Total OS Insensitive (Subtotal)':<34}{os_insensitive_cnt:<34}{'0':<20}{os_insensitive_cnt:<20}")
    # print("-" * 100)
    print(f"{'Grand Total':<34}{os_sensitive_cnt+os_insensitive_cnt:<20}{os_sensitive_version_cnt:<20}{os_sensitive_cnt+os_insensitive_cnt+os_sensitive_version_cnt:<20}")
